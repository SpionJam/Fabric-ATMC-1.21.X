...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.SULFUR_ORE, createOreDrop(ModBlocks.SULFUR_ORE, ModItems.SULFUR_DUST));

        // Loot-Tabelle für PITCH_COAL_ORE
        addDrop(ModBlocks.PITCH_COAL_ORE, createOreDrop(ModBlocks.PITCH_COAL_ORE, ModItems.PITCH_COAL));
    }
