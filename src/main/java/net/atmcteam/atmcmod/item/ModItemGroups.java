    ...
    public static final ItemGroup ATMC_MOD_ITEMS = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.PURE_AMETHYST_SHARD))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModItems.END_ESSENCE_HELMET);
                        entries.add(ModItems.END_ESSENCE_CHESTPLATE);
                        entries.add(ModItems.END_ESSENCE_LEGGINGS);
                        entries.add(ModItems.END_ESSENCE_BOOTS);
                        entries.add(ModItems.FOREST_ESSENCE);
                        entries.add(ModItems.FOREST_ESSENCE_INGOT);
                        entries.add(ModItems.FOREST_ESSENCE_HELMET);
                        entries.add(ModItems.FOREST_ESSENCE_CHESTPLATE);
                        entries.add(ModItems.FOREST_ESSENCE_LEGGINGS);
                        entries.add(ModItems.FOREST_ESSENCE_BOOTS);
                        entries.add(ModItems.OCEAN_ESSENCE);
                        entries.add(ModItems.OCEAN_ESSENCE_INGOT);
                        entries.add(ModItems.OCEAN_ESSENCE_HELMET);
                        entries.add(ModItems.OCEAN_ESSENCE_CHESTPLATE);
                        entries.add(ModItems.OCEAN_ESSENCE_LEGGINGS);
                        entries.add(ModItems.OCEAN_ESSENCE_BOOTS);
                        entries.add(ModItems.NETHER_ESSENCE);
                        entries.add(ModItems.NETHER_ESSENCE_INGOT);
                        entries.add(ModItems.NETHER_ESSENCE_HELMET);
                        entries.add(ModItems.NETHER_ESSENCE_CHESTPLATE);
                        entries.add(ModItems.NETHER_ESSENCE_LEGGINGS);
                        entries.add(ModItems.NETHER_ESSENCE_BOOTS);
                        entries.add(ModItems.ULTIMATIVE_ESSENCE);
                        entries.add(ModItems.ULTIMATIVE_ESSENCE_INGOT);
